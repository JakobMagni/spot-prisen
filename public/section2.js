 //section 2 linjediagram
            ...
            var xScale = d3.scaleLinear().domain([1, 52])
              ...
              d3.json("/api/diagram2", {
                ...
                lines.enter()
                 ...
                 // Update new data
                  ...
                  .attr("d", line)
                  .duration(6000)
                  .attrTween("stroke-dasharray", tweenDash) // Her bruger vi growing line funktionen defineret længere oppe 
                  .style("stroke", () =>
                    '#000000'
                  );
              })
